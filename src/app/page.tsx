...
const globeConfig = {
  ...
  return (
    <div className="mainDiv">
      <div className="relative min-h-screen bg-black text-white" style={{marginBottom: "50px"}}>
        <BackgroundBeams className="absolute inset-0 z-0" />
        <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 py-12">
          <div className="hero BigText text-center mb-8">
            <Image preview={false} src={MozillaLogo.src} style={{ width: "80%", maxWidth: "400px", margin: "0 auto" }}/>
            <h1 className="mb-[10px] text-4xl md:text-6xl lg:text-7xl font-bold mt-4" style={{fontSize: "clamp(2rem, 5vw, 5rem)"}}>Ignite Your Passion for Technology</h1>
            <h2 className="text-xl md:text-xl mt-4">Join Mozilla Phoenix Club at JUET - Fueling innovation, creativity, and collaboration in the tech world</h2>
          ...
          <div className="flex justify-center items-center mt-8" style={{ marginBottom : "40px" }}>
            <Button
              onClick={handleClick}
              duration={2000}
            ...
            >
              <div style={{ display: "flex", flexDirection: "row", alignItems: "center"}}>
                <span style={{ marginLeft: "8px", color: "white", fontSize: "clamp(1rem, 2vw, 1.25rem)", fontWeight: "600" }}>Join the Revolution</span>
              </div>
            </Button>
          </div>
        </div>
      ...
      <section className="section bg-black text-white relative">
        <div className="hero BigText text-center">
          <h2 className="text-globe text-3xl md:text-4xl lg:text-5xl" style={{ paddingTop: "150px" }}>Events</h2>
        </div> 
      ...
      <section className="relative z-30 bg-black text-white pt-20 md:pt-40">
        <div className="hero BigText text-center mb-12 md:mb-20">
          <h2 className="text-globe z-40 text-3xl md:text-4xl lg:text-5xl">Why Join Us</h2>
          <p className="text2 mt-4 mb-0 text-base md:text-lg px-4">
        ...
        <div className="flex flex-col md:flex-row justify-evenly items-center px-4 md:px-10 space-y-8 md:space-y-0 md:space-x-4">
          {/* Card 1 */}
            ...
            <div className="relative max-w-xs">
              ...
              <div className="relative shadow-xl bg-gray-900 border border-gray-800 px-4 py-8 h-full overflow-hidden rounded-2xl flex flex-col justify-end items-start">
                ...
                <p className="font-normal text-base text-slate-500 mb-4 relative z-50">
                  Work on practical projects that will bolster your resume and give you hands-on experience.
                </p>
          ...
          <div className="w-full md:w-1/3 max-w-xs">
            <div className="relative max-w-xs">
              ...
              <div className="relative shadow-xl bg-gray-900 border border-gray-800 px-4 py-8 h-full overflow-hidden rounded-2xl flex flex-col justify-end items-start">
                ...
                <p className="font-normal text-base text-slate-500 mb-4 relative z-50">
                  Participate in events that challenge your coding, problem-solving, and teamwork skills.
                </p>
                <button className="border px-4 py-1 rounded-lg border-gray-500 text-gray-300">
                  Explore
                </button>
          ...
          <div className="w-full md:w-1/3 max-w-xs">
            <div className="relative max-w-xs">
              ...
              <div className="relative shadow-xl bg-gray-900 border border-gray-800 px-4 py-8 h-full overflow-hidden rounded-2xl flex flex-col justify-end items-start">
                ...
                <p className="font-normal text-base text-slate-500 mb-4 relative z-50">
                  Our project-based approach ensures you're building skills that are directly applicable to the workplace, helping you secure top placements.
                </p>
                <button className="border px-4 py-1 rounded-lg border-gray-500 text-gray-300">
                  Explore
                </button>
